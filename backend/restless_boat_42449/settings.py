"""
Django settings for restless_boat_42449 project.
...
ROOT_URLCONF = 'restless_boat_42449.urls'
...
WSGI_APPLICATION = 'restless_boat_42449.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_boat_42449 API",
    "DESCRIPTION": "API documentation for restless_boat_42449 App",
    "VERSION": "v1",
}
